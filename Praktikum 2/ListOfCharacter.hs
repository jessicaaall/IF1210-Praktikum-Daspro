...
-- KONKATENASI                      konkat(lc1,lc2)

-- DEFINISI DAN SPESIFIKASI
konkat :: [Char] -> [Char] -> [Char]
{- konkat(lc1,lc2) menerima masukan 2 buah list of character, lc1 dan lc2,
    yang masing-masing mungkin kosong, dan menghasilkan list baru yang merupakan 
    penggabungan lc1 dengan lc2 (lc1 di awal). -}

-- REALISASI
konkat lc1 lc2 =
    if isEmpty lc1 then     -- Basis
        lc2
    else                    -- Rekurens
